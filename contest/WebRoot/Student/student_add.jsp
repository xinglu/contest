...
<div id="studentAddDiv">
	<form id="studentAddForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="student_contest_contestId" name="student.contest.contestId" style="width: auto"/>
			</span>
		</div>
		<div>
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="student_signUpTime" name="student.signUpTime" />
