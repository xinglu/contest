...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>比赛id</td><td>举办学校</td><td>比赛项目</td><td>比赛名称</td><td>比赛地点</td><td>人数限制</td><td>报名时间</td><td>截止时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="contestQueryForm" id="contestQueryForm" action="<%=basePath %>Contest/frontlist" class="mar_t15" method="post">
