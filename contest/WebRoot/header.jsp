        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>School/frontlist">学校</a></li>
                <li><a href="<%=basePath %>Project/frontlist">项目</a></li>
                <li><a href="<%=basePath %>Contest/frontlist">比赛</a></li>
                <li><a href="<%=basePath %>Student/frontlist">报名学生</a></li>
                <li><a href="<%=basePath %>Score/frontlist">比赛成绩</a></li>
